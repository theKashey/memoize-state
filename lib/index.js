  ...
  if ((typeof result === 'undefined' ? 'undefined' : _typeof(result)) === 'object') {
    ...
    for (var i in result) {
      if (result.hasOwnProperty(i)) {
        var data = result[i];
        var _isInProxy = (0, _proxyequal.isProxyfied)(data);
        // if (isInProxy) {
        //   altered = true;
...
function callIn(that, cache, args, func, memoizationDepth) {
  var proxies = args.map(function (arg, index) {
    return arg && (typeof arg === 'undefined' ? 'undefined' : _typeof(arg)) === 'object' ? (0, _proxyequal.proxyState)(arg, index) : undefined;
  });
  ...
  Object.defineProperty(functor, 'cacheStatistics', {
    get: function get() {
      ...
      return _ref = {
        ...
        cacheHit: cacheHit
      }, _defineProperty(_ref, 'cacheHit', cacheHit), _defineProperty(_ref, 'runTimes', runTimes), _defineProperty(_ref, 'executeTimes', executeTimes), _defineProperty(_ref, 'cache', cache), _ref;
    },
    configurable: true
  });
