...
function buildCompare(test, compare) {
  return function (cache, args) {
    for (var i = 0; i < cache.length; ++i) {
      ...
      for (var j = 0; j < args.length; ++j) {
        ...
        if (a === b || (typeof a === 'undefined' ? 'undefined' : _typeof(a)) === 'object' && (affected.length === 0 || compare(a, b, affected))) {
          //pass
        } else {
          found = null;
          break;
...
var shallowHit = buildCompare(0, _proxyequal.proxyCompare);
var equalHit = buildCompare(1, _proxyequal.proxyCompare);
var shallowEqualHit = buildCompare(2, _proxyequal.proxyShallowEqual);
...
function addAffected(affected, object) {
  ...
  affected[key.fingerPrint][2].push(key.suffix);
}
...
function callIn(that, cache, args, func, memoizationDepth) {
  ...
  var affected = proxies.map(function (proxy) {
    if (proxy) {
      ...
      return [(0, _proxyequal.collectShallows)(_affected), (0, _proxyequal.collectValuables)(_affected), [].concat(_toConsumableArray(_affected))];
    }
    return undefined;
  });
      ...
      try {
        for (var _iterator2 = cache[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          for (var argN = 0; argN < lineAffected.length; argN++) {
            ...
            try {
              for (var _iterator3 = lineAffected[argN][1][Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
